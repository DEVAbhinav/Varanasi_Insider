...
export function generateOrganizationSchema() {
    return {
        ...
        url: SITE_URL,
        logo: `${SITE_URL}https://res.cloudinary.com/dkntlqbwr/image/upload/kashitaxi/logo.jpeg`,
        sameAs: [
...
export function generateServiceSchema(data) {
    ...
    const schema = {
        ...
        provider: {
            ...
            telephone: provider?.telephone || '+91-9450301573',
...
export function generateArticleSchema(data) {
    ...
    const schema = {
        ...
        publisher: {
            ...
            logo: {
                '@type': 'ImageObject',
                url: publisherLogo || `${SITE_URL}https://res.cloudinary.com/dkntlqbwr/image/upload/kashitaxi/logo.jpeg`
            }
        },
...
export function generateEventSchema(data) {
    ...
    const imageUrl = image
        ...
        : `${SITE_URL}https://res.cloudinary.com/dkntlqbwr/image/upload/kashitaxi/varanasi-hero.png`;
