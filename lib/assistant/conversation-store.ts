...
if (process.env.NODE_ENV === 'development') {
    const seedMockData = async () => {
        ...
        const existing = await conversationStore.getConversation(mockPhone);
        if (!existing) {
            await conversationStore.addMessage({
                conversationId: mockPhone,
                messageId: 'm1',
                role: 'customer',
                content: 'Namaste! I am planning a trip to Varanasi next month with my family. Can you help with a 12-seater tempo traveller for airport pickup?',
            ...
            await conversationStore.addMessage({
                ...
                messageId: 'm2',
                role: 'agent',
                content: 'Namaste Abhishek Ji! 🙏 Welcome to Varanasi. Yes, we specialize in family trips and have clean, comfortable 12-seater Tempo Travellers. What is your flight arrival time?',
            ...
            await conversationStore.addMessage({
                ...
                messageId: 'm3',
                role: 'customer',
                content: 'We are reaching at 10 AM on 15th Feb. We also need to visit Kashi Vishwanath Temple and Sarnath. Is it safe for elderly parents?',
