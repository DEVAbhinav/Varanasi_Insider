...
const BLOCKS = {
  ...
  LOLARK: {
    en: {
      ...
      cta: {
        ...
        sub: 'For couples planning to visit Lolark Kund around the provisional 17 Sep 2026 observance: confirm the temple date before booking date-specific <b>queue assistance, priest coordination</b> or transport.',
        primary: {
    ...
    hi: {
      ...
      cta: {
        ...
        sub: 'लोलार्क कुंड की संभावित 17 सितंबर 2026 तिथि के लिए: तारीख-विशिष्ट <b>लाइन सहायता, पुरोहित समन्वय</b> या ट्रांसपोर्ट बुक करने से पहले मंदिर की स्थानीय तिथि की पुष्टि करें।',
        primary: {
  ...
  // Shardiya Navratri / Kashi Nava Durga Yatra — use on Navratri and festival pages.
  NAVRATRI: {
    en: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🌸 Kashi Nava Durga Darshan — Cab, Boat & Local Guide Coordination',
        sub: 'Visiting the 9 sacred Durga temples during Navratri? Skip the parking jams and confusion in the galis. We arrange <b>fixed-fare AC cabs for outer temples (Shailputri, Skandamata, Durga Kund)</b>, private ghat boat transfers to bypass old-city gridlocks, and experienced local assistance.',
        primary: {
          label: '📲 Plan Nava Durga Yatra on WhatsApp',
          waText: 'Namaste, I want help planning the Kashi Nava Durga Yatra (cabs + boat + guide assistance). My travel dates & group size:',
        },
        call: { label: 'or 📞 +91 99354 74730' },
        more: { label: 'See fixed transport prices →', href: '/en/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🕉️ 9 Temples Covered' },
        { title: '🚕 Fixed Cab Rates' },
        { title: '🛶 Boat Bypass Option' },
        { title: '🛡️ Verified Local Team' },
      ],
    },
    hi: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🌸 काशी नवदुर्गा दर्शन — कैब, नाव व लोकल गाइड समन्वय',
        sub: 'नवरात्रि में 9 नवदुर्गा मंदिरों के दर्शन की योजना बना रहे हैं? गलियों के जाम और पार्किंग के झंझट से बचें। हम <b>बाहरी मंदिरों (शैलपुत्री, स्कंदमाता, दुर्गा कुंड) हेतु फिक्स्ड किराए वाली AC कैब</b>, जाम से बचने हेतु प्राइवेट नाव और अनुभवी स्थानीय सहायता उपलब्ध कराते हैं।',
        primary: {
          label: '📲 WhatsApp पर नवदुर्गा यात्रा प्लान करें',
          waText: 'नमस्ते, मुझे काशी नवदुर्गा यात्रा (कैब + नाव + गाइड सहायता) की व्यवस्था करनी है। मेरी तारीख व लोगों की संख्या:',
        },
        call: { label: 'या 📞 +91 99354 74730' },
        more: { label: 'फिक्स्ड ट्रांसपोर्ट दरें देखें →', href: '/hi/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🕉️ 9 पवित्र मंदिर' },
        { title: '🚕 फिक्स्ड कैब किराया' },
        { title: '🛶 नाव से जाम-मुक्त रूट' },
        { title: '🛡️ वेरिफाइड लोकल टीम' },
      ],
    },
  },

  // Sorahia Mela / Lakshmi Kund Mahalakshmi Vrat & Jitiya darshan assistance — use on Lakshmi Kund pages.
  SORAHIA: {
    en: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🪔 Sorahia Mela & Lakshmi Kund Darshan — Cab & Local Support',
        sub: 'Visiting Lakshmi Kund for the 16-day Mahalakshmi Vrat or Jivitputrika (Jitiya) snan? Luxa road is heavily barricaded. We arrange <b>fixed-fare pre-dawn pickups, drops at Gurubagh / Girjaghar perimeter</b>, family Tempo Travellers, and safe hotel transfers without festival surge.',
        primary: {
          label: '📲 Plan Lakshmi Kund Visit on WhatsApp',
          waText: 'Namaste, I need transport and hotel assistance for Sorahia Mela / Lakshmi Kund darshan in Varanasi. Travel date & group size:',
        },
        call: { label: 'or 📞 +91 99354 74730' },
        more: { label: 'See fixed transport prices →', href: '/en/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🛕 Lakshmi Kund Access' },
        { title: '🚕 Guaranteed No-Surge Cabs' },
        { title: '👵 Senior Citizen Drop Support' },
        { title: '🏨 Trusted Sigra / Luxa Stays' },
      ],
    },
    hi: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🪔 सोरहिया मेला व लक्ष्मी कुंड दर्शन — कैब व स्थानीय सहायता',
        sub: '16-दिवसीय महालक्ष्मी व्रत या जीवित्पुत्रिका (जिउतिया) स्नान हेतु लक्ष्मी कुंड आ रहे हैं? लक्सा मार्ग पर भारी बैरिकेडिंग रहती है। हम <b>गुरुबाग / गिरिजाघर तक फिक्स्ड किराए वाली कैब</b>, परिवार हेतु टेम्पो ट्रैवलर और बिना किसी सर्ज प्राइस के सुरक्षित यात्रा उपलब्ध कराते हैं।',
        primary: {
          label: '📲 WhatsApp पर लक्ष्मी कुंड यात्रा प्लान करें',
          waText: 'नमस्ते, मुझे वाराणसी में सोरहिया मेला / लक्ष्मी कुंड दर्शन हेतु ट्रांसपोर्ट और होटल सहायता चाहिए। तारीख व यात्रियों की संख्या:',
        },
        call: { label: 'या 📞 +91 99354 74730' },
        more: { label: 'फिक्स्ड ट्रांसपोर्ट दरें देखें →', href: '/hi/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🛕 लक्ष्मी कुंड सुगम पहुंच' },
        { title: '🚕 बिना सर्ज फिक्स्ड कैब' },
        { title: '👵 बुजुर्गों हेतु निकटतम ड्रॉप' },
        { title: '🏨 सिगरा / लक्सा में भरोसेमंद स्टे' },
      ],
    },
  },

  // Durga Puja pandal hopping & night transit assistance — use on Durga Puja & Navratri pages.
  DURGA_PUJA: {
    en: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🪔 Varanasi Durga Puja Pandal Hopping — Fixed Cabs & Standby',
        sub: 'Visiting Sanatan Dharm, Hathua Market, or Bengali Tola? Central roads are under strict No-Vehicle lockdown (4 PM–4 AM). We arrange <b>fixed-fare night standby cabs, perimeter drops at Maldahiya / Bhelupur</b>, family Tempo Travellers, and safe hotel returns without midnight surge.',
        primary: {
          label: '📲 Plan Pandal Tour on WhatsApp',
          waText: 'Namaste, I want to book a fixed-fare cab / tempo traveller for Durga Puja pandal hopping in Varanasi. Travel date, hours & group size:',
        },
        call: { label: 'or 📞 +91 99354 74730' },
        more: { label: 'See festival cab rates →', href: '/en/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🛕 Pandal Hopping Standby' },
        { title: '🚕 Guaranteed No-Surge Cabs' },
        { title: '👵 Senior Citizen Drop Points' },
        { title: '🏨 Verified Stays with Car Access' },
      ],
    },
    hi: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🪔 वाराणसी दुर्गा पूजा पंडाल दर्शन — फिक्स्ड कैब व नाइट स्टैंडबाय',
        sub: 'सनातन धर्म, हथुआ मार्केट या बंगाली टोला के पंडाल दर्शन हेतु आ रहे हैं? शहर के प्रमुख मार्ग शाम 4 बजे से रात 4 बजे तक सील रहते हैं। हम <b>मलदहिया व भेलूपुर ड्रॉप, 4 व 8 घंटे स्टैंडबाय कैब</b> और बिना किसी सर्ज प्राइस के सुरक्षित पारिवारिक यात्रा उपलब्ध कराते हैं।',
        primary: {
          label: '📲 WhatsApp पर पंडाल यात्रा बुक करें',
          waText: 'नमस्ते, मुझे वाराणसी में दुर्गा पूजा पंडाल दर्शन हेतु फिक्स्ड कैब / टेम्पो ट्रैवलर बुक करनी है। तारीख, समय व यात्रियों की संख्या:',
        },
        call: { label: 'या 📞 +91 99354 74730' },
        more: { label: 'फेस्टिवल ट्रांसपोर्ट दरें देखें →', href: '/hi/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🛕 पंडाल दर्शन नाइट स्टैंडबाय' },
        { title: '🚕 बिना सर्ज फिक्स्ड किराया' },
        { title: '👵 बुजुर्गों हेतु निकटतम ड्रॉप' },
        { title: '🏨 कार पहुंच वाले सुरक्षित स्टे' },
      ],
    },
  },

  // Maa Annapurna Swarna Roop Darshan & Annakut Mahotsav — use on Annapurna & Diwali festival pages.
  ANNAPURNA_ANNAKUT: {
    en: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🪙 Maa Annapurna Swarna Darshan 2026 — Cab & Perimeter Drop Assistance',
        sub: 'Visiting the once-a-year Golden Annapurna Darshan & Annakut (6–11 Nov 2026)? The Godowlia–Chowk route is a strict <b>No-Vehicle Pedestrian Zone</b>. We provide <b>fixed-fare airport/station cabs, designated drops at Benia Bagh / Girjaghar</b>, elder-friendly standby cabs, and clean outstation family Tempo Travellers with zero festival surge pricing.',
        primary: {
          label: '📲 Book Annapurna Darshan Cab on WhatsApp',
          waText: 'Namaste, I need a fixed-fare cab / tempo traveller for Maa Annapurna Swarna Darshan in Varanasi. Travel date, pickup & group size:',
        },
        call: { label: 'or 📞 +91 99354 74730' },
        more: { label: 'See fixed cab rates →', href: '/en/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🛕 Swarna Darshan Perimeter Drop' },
        { title: '🚕 Guaranteed Zero-Surge Cabs' },
        { title: '👵 Senior Citizen Drop Points' },
        { title: '🏨 Stays with Direct Road Access' },
      ],
    },
    hi: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🪙 मां अन्नपूर्णा स्वर्ण दर्शन 2026 — फिक्स्ड कैब व पेरीमीटर ड्रॉप सेवा',
        sub: 'वर्ष में केवल 5 दिन (6 से 11 नवंबर 2026) होने वाले स्वर्णमयी अन्नपूर्णा दर्शन व अन्नकूट हेतु आ रहे हैं? गोदौलिया-चौक मार्ग पूरी तरह <b>नो-व्हीकल जोन</b> रहता है। हम <b>बेनियाबाग व गिरजाघर निकटतम ड्रॉप, एयरपोर्ट/स्टेशन पिकअप</b>, बुजुर्गों हेतु स्टैंडबाय कैब और बिना किसी सर्ज प्राइस के सुरक्षित पारिवारिक टेम्पो ट्रैवलर उपलब्ध कराते हैं।',
        primary: {
          label: '📲 WhatsApp पर अन्नपूर्णा दर्शन कैब बुक करें',
          waText: 'नमस्ते, मुझे वाराणसी में मां अन्नपूर्णा स्वर्ण दर्शन हेतु फिक्स्ड कैब / टेम्पो ट्रैवलर बुक करनी है। तारीख, पिकअप व यात्रियों की संख्या:',
        },
        call: { label: 'या 📞 +91 99354 74730' },
        more: { label: 'फिक्स्ड ट्रांसपोर्ट दरें देखें →', href: '/hi/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🛕 स्वर्ण दर्शन निकटतम ड्रॉप' },
        { title: '🚕 बिना सर्ज फिक्स्ड किराया' },
        { title: '👵 वरिष्ठ नागरिकों हेतु सुगम सेवा' },
        { title: '🏨 मुख्य मार्ग पर स्थित होटल' },
      ],
    },
  },

  // Chetganj Nakkataiya Lakkha Mela — use on Chetganj Nakkataiya, Ramlila, and October festival pages.
  NAKKATAIYA_MELA: {
    en: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🎭 Chetganj Nakkataiya Mela 2026 — Night Cab & Perimeter Drop Assistance',
        sub: 'Heading to Varanasi\'s legendary 139-year-old nocturnal Lakkha Mela on Karwa Chauth night (29–30 Oct 2026)? The entire Maldahiya–Lahurabir–Chetganj corridor is a strict <b>No-Vehicle Zone from 6:00 PM to 6:00 AM</b>. We provide <b>guaranteed fixed-fare overnight standby cabs, designated drops at Englishia Line / Sigra Crossing</b>, airport transfers, and family Tempo Travellers with verified local chauffeurs.',
        primary: {
          label: '📲 Book Mela Night Cab on WhatsApp',
          waText: 'Namaste, I need a fixed-fare cab / tempo traveller for Chetganj Nakkataiya Lakkha Mela in Varanasi. Travel date, pickup location & group size:',
        },
        call: { label: 'or 📞 +91 99354 74730' },
        more: { label: 'See fixed transport prices →', href: '/en/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🌙 All-Night Standby Cabs' },
        { title: '🚧 Designated Perimeter Drops' },
        { title: '👵 Senior & Family Safe Transit' },
        { title: '🚕 Zero Festival Surge Tariffs' },
      ],
    },
    hi: {
      compactStrip: true,
      cta: {
        variant: 'card',
        align: 'left',
        title: '🎭 चेतगंज नक्कटैया लक्खा मेला 2026 — नाइट कैब व पेरीमीटर ड्रॉप सेवा',
        sub: 'करवाचौथ की रात (29–30 अक्टूबर 2026) काशी के 139 वर्ष प्राचीन ऐतिहासिक लक्खा मेले में शामिल हो रहे हैं? मलदहिया से नई सड़क तक पूरा मार्ग शाम 6:00 बजे से भोर 6:00 बजे तक <b>सख्त नो-व्हीकल जोन</b> रहता है। हम उपलब्ध कराते हैं <b>रात भर स्टैंडबाय फिक्स्ड कैब, इंग्लिशिया लाइन व सिगरा चौराहा निकटतम ड्रॉप</b>, एयरपोर्ट/स्टेशन पिकअप और बिना किसी सर्ज प्राइस के सुरक्षित पारिवारिक टेम्पो ट्रैवलर।',
        primary: {
          label: '📲 WhatsApp पर नक्कटैया मेला कैब बुक करें',
          waText: 'नमस्ते, मुझे वाराणसी में चेतगंज नक्कटैया लक्खा मेला हेतु फिक्स्ड नाइट कैब / टेम्पो ट्रैवलर चाहिए। तारीख, पिकअप व यात्रियों की संख्या:',
        },
        call: { label: 'या 📞 +91 99354 74730' },
        more: { label: 'फिक्स्ड ट्रांसपोर्ट दरें देखें →', href: '/hi/varanasi-transport-price-guide-2026' },
      },
      strip: [
        { title: '🌙 रात भर स्टैंडबाय कैब' },
        { title: '🚧 अधिकृत पेरीमीटर ड्रॉप' },
        { title: '👵 बुजुर्गों व परिवारों हेतु सुगम सेवा' },
        { title: '🚕 बिना सर्ज फिक्स्ड किराया' },
      ],
    },
  },
...
function buildRouteCabBlock(route) {
  const est = estimateRoute({
    ...
    minFare: route.minFare || route.fixedFare,
    fixedFare: route.fixedFare || route.minFare,
  });
...
function buildRouteHeroBlock(route, dir, lang) {
  ...
  const dzOw = estimateRoute({ vehicleId: 'dzire', distanceKm: route.distanceKm, tripType: 'one-way', minBillKm: route.minBillKm, minFare: route.minFare || route.fixedFare, fixedFare: route.fixedFare || route.minFare });
  const dzRt = estimateRoute({ vehicleId: 'dzire', distanceKm: route.distanceKm, tripType: 'round-trip', minBillKm: route.minBillKm, minFare: route.minFare || route.fixedFare, fixedFare: route.fixedFare || route.minFare });
