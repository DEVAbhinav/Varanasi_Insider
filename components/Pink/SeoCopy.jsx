    ...
    <section className="bg-white px-4 py-16">
      <div className="mx-auto max-w-5xl space-y-6 text-gray-700">
        ...
        <p className="text-base leading-relaxed md:text-lg">
          ...
          or call <a className="text-pink-600 underline" href={getCallTelHref()}>{CONTACT.callNumberDisplay}</a>. Share arrival details, headcount and luggage, and we will lock the fare (parking, night allowance, tolls) before you travel. For city itineraries, combine
