  ...
  return (
    <section className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src={heroImage || 'https://res.cloudinary.com/dkntlqbwr/image/upload/kashitaxi/kashitaxi/varanasi-ghat-wallpaper-p.jpeg'}
          alt={title}
          fill
      ...
      <div className="relative z-10 h-full flex flex-col justify-end pb-16 px-6 md:px-12 max-w-6xl mx-auto">
        <div className="text-white">
          ...
          {subtitle && (
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-6 max-w-3xl">
              {subtitle}
            </p>
          )}
          {phone && (
