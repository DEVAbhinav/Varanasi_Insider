...
export default function StickyContactBar({ 
  ...
  const variants = {
    spiritual: {
      ...
      title: "🙏 Need spiritual guidance or travel help?",
    ...
    simple: {
      ...
      subtitle: "Quick response • Expert assistance",
    ...
    <>
      ...
      <div
        ...
        style={{ 
          ...
          boxShadow: '0 -4px 16px rgba(0, 0, 0, 0.2), 0 -2px 8px rgba(255, 107, 53, 0.3)',
          borderTop: variant === 'spiritual' ? '2px solid rgba(255, 215, 0, 0.5)' : 'none'
        }}
      >
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          <div className="text-white">
            <p className="text-base font-bold drop-shadow-md">{style.title}</p>
            <p className="text-xs text-yellow-50 opacity-90">{style.subtitle}</p>
          </div>
          <div className="flex gap-3">
            <a
              href={`tel:${phone}`}
              className="inline-flex items-center px-5 py-2.5 bg-white text-orange-600 font-bold rounded-lg hover:bg-yellow-50 transition-all transform hover:scale-105 shadow-lg text-sm border-2 border-orange-200"
            ...
            <a
              ...
              className="inline-flex items-center px-5 py-2.5 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition-all transform hover:scale-105 shadow-lg text-sm"
