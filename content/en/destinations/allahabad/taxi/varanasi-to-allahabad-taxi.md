...
| Detail | Information |
|--------|-------------|
| **City Name (Current)** | Prayagraj |
| **City Name (Former)** | Allahabad |
| **Name Changed** | October 2018 |
| **Distance from Varanasi** | 120 km |
| **Travel Time** | 2.5 hours |
| **Starting Fare** | ₹2,500 for sedan |
| **Main Attraction** | Triveni Sangam (holiest confluence) |
| **Famous For** | Kumbh Mela (world's largest gathering) |

## Why Was Allahabad Renamed to Prayagraj?

**Historical Context**:
- **Prayagraj** = Ancient Sanskrit name (mentioned in Vedas, Puranas)
- **Meaning**: "Prayag" (place of sacrifice) + "Raj" (king) = "King of sacred places"
- **Allahabad** = Name given during Mughal emperor Akbar's reign (1583)
- **Renaming**: Part of restoring ancient Hindu names to cities
...
**Distance**: 120 km  
**Time**: 2.5 hours  
**Fare**: ₹2,500-2,800 (sedan)  

**Popular Routes**:
- Varanasi → Triveni Sangam
- Varanasi → Allahabad Fort
- Varanasi → Allahabad University
- Varanasi → Prayagraj Airport

**Best For**:
- Triveni Sangam holy bath (snan)
- Kumbh Mela pilgrimage
- Day trip from Varanasi
- Airport transfer
- Business travel to Prayagraj
...
**Uttar Pradesh Spiritual Circuit**
- Varanasi → Prayagraj → Ayodhya → Varanasi
- **3-day package**: ₹8,500 for sedan
- All major Hindu pilgrimage sites
