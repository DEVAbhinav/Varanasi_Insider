...
faqSchema:
  ...
  - question: "Do seats recline fully for elders to rest?"
    answer: "Seats recline to 135° with adjustable headrests. We add travel cushions and blankets on request." 
---
...
| ![12-seater Traveller ready outside Ayodhya Ram Mandir parking](/images/AyodhyaBus1.jpg "12-seater staged for family charter") | ![Interior view showing compact 12-seater layout with ambient lights](/images/Temp_travellar_inside.jpeg "Comfortable 12-seater seating layout") | ![Close-up of cushioned seats with seatbelts and storage pockets](/images/Tempo_travellar_seat_closup.jpeg "Seat detail with storage and belts") |
| --- | --- | --- |

## 12-Seater Tempo Traveller Seat Map & Amenities

```
[Driver] [Navigator Seat]
Row 1: 2 seats (window + aisle)
Row 2: 3 seats (1 jump seat foldable)
Row 3: 3 seats
Row 4: 3 seats + rear luggage bay
```

- Plush push-back seats with armrests
- Overhead parcel rack for handbags and shawls
- Rear luggage bay (fits 5 medium suitcases)
- Icebox with chilled water, ORS sachets, herbal candy
- Ambient LED lighting, Bluetooth audio, phone charging

## Ayodhya Day Plan Tailored for Small Families

| Time | Plan | 12 Seater Advantage |
| --- | --- | --- |
| 5:00 AM | Pick-up from home/ghat | Compact vehicle reaches narrow lanes easily. |
| 6:15 AM | Breakfast at Handia plaza | Small group gets quicker seating; driver pre-orders tea. |
| 9:30 AM | Arrive Ayodhya | Navigator seat doubles as coordinator desk for darshan passes. |
| 9:45–11:15 AM | Ram Mandir darshan | Keep valuables in lockable glovebox; kids watch devotional videos on screens. |
| 11:30 AM | Hanuman Garhi & Kanak Bhawan | Flexible enough to manoeuvre closer to drop points. |
| 1:00 PM | Lunch (Brijwasi) | Seats arranged together for family; driver assists elders. |
| 2:30 PM | Ram Ki Paidi stroll | Foldable stools & umbrella stored onboard. |
| 4:00 PM | Shopping | Rear boot stores bulk prasad boxes without crowding seats. |
| 5:00 PM | Depart | Kids nap comfortably—blankets provided. |
| 8:45 PM | Return Varanasi | Drop at multiple homes—Traveller fits into residential lanes. |

## 12-Seater Tempo Traveller Pricing & Add-Ons

![Family sharing prasad inside Traveller during return leg](/images/Tempo_travellar_side_l.jpeg "Family sharing prasad during return journey")
...
> Inclusive of tolls, parking, fuel, driver allowance, water, and sanitizer. GST 5% if invoice needed.

## EAAT Alignment for Ayodhya Family Trips
...
- Seat elders in Row 2 (least vibration) and assign kids to Row 3 with window view.
- Use overhead rack for shawls and prasad to keep floor uncluttered.
- Request baby/child car seat (₹250) if travelling with toddlers.
- Bring your bhajan playlist; Bluetooth connects instantly.
...
1. Share date, passenger count, special needs via https://wa.me/919935474730?text=Ayodhya%2012%20Seater.
2. Receive seat layout, vehicle photos, itinerary suggestions.
3. Block with ₹1,000 token. Balance post-trip by UPI/card.
